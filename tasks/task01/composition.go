...
/*
Тип Human с полями Name - имя человека, представлен типом string и полем Age -
возраст человека, представлен беззнаковым целым числом
*/
type Human struct {
	Name string
	Age  uint
...
"спецификатор" при обращении к методу.
Пример:
